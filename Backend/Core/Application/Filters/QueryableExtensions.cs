...
namespace Application.Filters
{
    public static class QueryableExtensions
    {
        ...
        /// <summary>
        /// Filters listings by sold/archived state.
        /// </summary>
        public static IQueryable<Listing> FilterByAvailability(this IQueryable<Listing> query, ListingFilter filter)
        {
        ...
        {
            if (filter.CityId.HasValue && chosenCity != null)
            {
                var radiusKm = filter.Radius == null ? 10000 : filter.Radius.Value * 1000;
                query = query.Where(listing =>
                    listing.CityId == chosenCity.Id ||
                    listing.City.Location.IsWithinDistance(chosenCity.Location, radiusKm));
            }
            return query;
        }
        ...
        /// </summary>
        public static IQueryable<Listing> ApplyCategoryFilters(this IQueryable<Listing> query,ListingFilter filter, IEnumerable<ListingProperty> categoryProperties, City? chosenCity = null)
        {
            return query
        ...
        public static IQueryable<Listing> ApplyAllListingsFilters(this IQueryable<Listing> query, ListingFilter filter, City? chosenCity = null)
        {
            return query
                .FilterByPrice(filter)
                .FilterByStateOfItem(filter)
